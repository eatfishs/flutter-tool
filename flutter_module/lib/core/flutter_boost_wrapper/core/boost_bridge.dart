...
class BoostBridge {
  static const MethodChannel _channel = MethodChannel('flutter_boost_bridge');
  static final BoostBridge _instance = BoostBridge._();

  BoostBridge._();

  static BoostBridge get instance => _instance;

  void init() {
    _channel.setMethodCallHandler(_handleMethodCall);
  }

  Future<dynamic> callNativeFunction(String method, [dynamic arguments]) {
